...
a = Analysis(['DFMODELSv2.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['pandas._libs.tslibs.timedeltas','statsmodels.tsa.statespace._filters', 'scipy._lib.messagestream', 'statsmodels.tsa.statespace._filters',
